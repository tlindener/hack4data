...
import static net.thinghub.joinhackathon.Constants.INVALID_FLOAT_VALUE;
import static net.thinghub.joinhackathon.Constants.INVALID_INT_VALUE;
import static net.thinghub.joinhackathon.Constants.INVALID_LONG_VALUE;
import static net.thinghub.joinhackathon.Constants.KEY_EXPIRATION_DURATION;
import static net.thinghub.joinhackathon.Constants.KEY_LATITUDE;
import static net.thinghub.joinhackathon.Constants.KEY_LONGITUDE;
import static net.thinghub.joinhackathon.Constants.KEY_PREFIX;
import static net.thinghub.joinhackathon.Constants.KEY_RADIUS;
import static net.thinghub.joinhackathon.Constants.KEY_TRANSITION_TYPE;
